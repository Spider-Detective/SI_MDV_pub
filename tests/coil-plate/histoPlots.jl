...
figure(1)
plot(range1,hist1,"ob--""",label="a=80,b=8.12")
plot(range2,hist2,"oy--",label="a=90,b=8.12")
plot(range3,hist3,"og--",label="a=100,b=8.12")
legend(bbox_to_anchor=[0.31,1],loc=0,borderaxespad=0)
xlabel("\$r_{SI-MDV}-r_{rrqr}, DR>1\$")
ylabel("Counts")
grid("on")
savefig("coil_rrqr_SI-MDV_far.pdf")
...
ylabel("Counts")
grid("on")
savefig("coil_svd_SI-MDV_far.pdf")
